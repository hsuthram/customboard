...
#
# Generated by Vivado on Wed Jun 17 15:19:09 EDT 2020
...
# Design libraries
design_libs=(xilinx_vip axi_infrastructure_v1_1_0 axi_vip_v1_1_6 processing_system7_vip_v1_0_8 xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_13)
...
compile()
{
  ...
  vlogan -work axi_vip_v1_1_6 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../project_2.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../project_2.srcs/sources_1/bd/design_1/ipshared/2d50/hdl" +incdir+"$ref_dir/../../../../project_2.srcs/sources_1/bd/design_1/ip/design_1_processing_system7_0_0" +incdir+"/tools/Xilinx/Vivado/2019.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../project_2.srcs/sources_1/bd/design_1/ipshared/dc12/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work processing_system7_vip_v1_0_8 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../project_2.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../project_2.srcs/sources_1/bd/design_1/ipshared/2d50/hdl" +incdir+"$ref_dir/../../../../project_2.srcs/sources_1/bd/design_1/ip/design_1_processing_system7_0_0" +incdir+"/tools/Xilinx/Vivado/2019.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../project_2.srcs/sources_1/bd/design_1/ipshared/2d50/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/hasitha/workspace/Vivado/project_2/project_2.cache/compile_simlib/vcs"
  fi
